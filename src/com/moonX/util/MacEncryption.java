...
public class MacEncryption {
	...
	public static final String encryption(String ethMac, String wifiMac, String chipMode){
		String ethMacConvert = convertMac(ethMac);
		String wifiMacConvert = convertMac(wifiMac);
		if(null == ethMacConvert ||
				null == wifiMacConvert ||
				null == chipMode) return null;
		
		String encryptionString = ethMacConvert + wifiMacConvert + chipMode;
		return MD5Util.getStringMD5_16(encryptionString);
	}
